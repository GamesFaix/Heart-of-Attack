...
namespace HOA
{
    ...
    public partial class Unit
    {
        ...
        public static Unit Ultratherium(ITokenCreator creator)
        {
            Unit u = new Unit(creator, Species.Ultratherium, Rank.King, Species.FirHeart);
        ...
        public static Unit GrizzlyElder(ITokenCreator creator)
        {
            Unit u = new Unit(creator, Species.Grizzly, Rank.Light);
        ...
        public static Unit Metaterrainean(ITokenCreator creator)
        {
            Unit u = new Unit(creator, Species.Metaterrainean, Rank.Heavy, Species.Rock);
            u.body = new Body(u, Plane.Ground, TokenFlags.Trample);
        ...
        public static Unit TalonedScout(ITokenCreator creator)
        {
            Unit u = new Unit(creator, Species.TalonedScout, Rank.Medium);
    ...
    {
        public static Obstacle Fir(ITokenCreator creator)
        {
            Obstacle o = new Obstacle(creator, Species.FirHeart);
