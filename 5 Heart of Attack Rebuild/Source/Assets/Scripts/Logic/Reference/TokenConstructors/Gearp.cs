...
namespace HOA 
{
    ...
    {
        public static Unit Kabutomachine(ITokenCreator creator)
        {
            Unit u = new Unit(creator, Species.Kabutomachine, Rank.King, Species.SiliconHeart);
        ...
        public static Unit CarapaceInvader(ITokenCreator creator)
        {
            Unit u = new Unit(creator, Species.Carapace, Rank.Medium);
        ...
        public static Unit Katandroid(ITokenCreator creator)
        {
            Unit u = new Unit(creator, Species.Katandroid, Rank.Light);
        ...
        public static Unit Mawth(ITokenCreator creator)
        {
            Unit u = new Unit(creator, Species.Mawth, Rank.Heavy);
            u.body = new Body(u, Plane.Air);
    ...
    {
        public static Obstacle Silicon(ITokenCreator creator)
        {
            Obstacle o = new Obstacle(creator, Species.SiliconHeart);
