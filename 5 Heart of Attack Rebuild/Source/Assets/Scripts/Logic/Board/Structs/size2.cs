...
{
    /// <summary>
    /// Pair of int32's for measuring 2-dimensional collections.
    /// Components must be greater than 0.
    /// </summary>
    public struct size2 : IEnumerable, IEquatable<size2>
    {
        ...
        /// <summary>
        /// Create new size2.  Throws exception if components out of range.
        /// </summary>
        /// <param name="x"></param>
        /// <param name="y"></param>
        ...
        /// <summary>
        /// Product of compnents
        /// </summary>
        public int Product { get { return x * y; } }

        /// <summary>
        /// Checks if index would be available in a two-dimensional collection of this size.
        /// </summary>
        /// <param name="i"></param>
        /// <returns>True if index x and y are less than size x and y.</returns>
        public bool Contains(index2 i) { return (i.x < x && i.y < y); }
        /// <summary>
        /// Checks if all components less than or equal to other size
        /// </summary>
        /// <param name="s"></param>
        /// <returns></returns>
        public bool SubsetOf(size2 s) { return (x <= s.x && y <= s.y); }
        /// <summary>
        /// Checks if all components greater than or equal to other size
        /// </summary>
        /// <param name="s"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Iterates through each index2 that would be available in a collection of this size.
        /// </summary>
        /// <returns></returns>
