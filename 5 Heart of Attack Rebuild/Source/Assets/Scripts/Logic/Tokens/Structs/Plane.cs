...
{ 
   ...
   [Flags]
    ...
    /// <summary>
    /// Provides set-like functionality to Plane.
    /// </summary>
    public static class PlaneExtensionMethods
    {
        /// <summary>
        /// Does this Plane contain any of the flags of the argument?
        /// </summary>
        ...
        /// <summary>
        /// Does the argument contain all the flags of This?
        /// </summary>
        /// <param name="p">This.</param>
        /// <param name="query"></param>
        ...
        /// <summary>
        /// Does This contain all the argument's flags?
        /// </summary>
        /// <param name="p">This.</param>
        /// <param name="query"></param>
        ...
        /// <summary>
        /// Does the argument contain all the flags of This, plus some others?
        /// </summary>
        /// <param name="p">This.</param>
        /// <param name="query"></param>
        ...
        /// <summary>
        /// Does This contain all the flags of the argument, plus some others?
        /// </summary>
        /// <param name="p">This.</param>
        /// <param name="query"></param>
