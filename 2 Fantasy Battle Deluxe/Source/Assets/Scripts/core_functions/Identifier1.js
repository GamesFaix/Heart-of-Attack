...
function I1011(object: GameObject){			
	...
	stats.actText[1,func]="MovLinGND";
		stats.actNums[1,tar]=lin;
		stats.actNums[1,rng]=4;
	stats.actText[3,func]="AtkSerpNRM";
	...
	stats.actText[4,func]="SpcSprint";
	...
	stats.actText[5,func]="SpcLaserSpin";
...
function I1012(object: GameObject){
	...
	stats.actText[1,func]="MovSerpGND";
		stats.actNums[1,tar]=serp;
		stats.actNums[1,rng]=3;
	stats.actText[3,func]="AtkSerpELC";
	...
	//stats.actText[4,func]="SpcShield";
	...
	stats.actText[5,func]="SpcFortifyShield";
...
function I1013(object: GameObject){
	...
	stats.actText[1,func]="MovLinFLY";
		stats.actNums[1,tar]=lin;
		stats.actNums[1,rng]=6;	
	stats.actText[3,func]="AtkLinLSR";
	...
	stats.actText[4,func]="SpcBarrage";
	...
	stats.actText[5,func]="SpcStockpile";
...
function I1014(object: GameObject){	
	...
	stats.actText[7,func]="CreateGND";
	...
	stats.actText[8,func]="CreateSentinel";
	...
	stats.actText[9,func]="CreateFLY";
...
function I1021(object: GameObject){
	...
	stats.actText[1,func]="MovSerpGND";//serp gnd
		stats.actNums[1,tar]=serp;
		stats.actNums[1,rng]=3;
	stats.actText[3,func]="AtkArcEXP";
	...
	stats.actText[4,func]="SpcEnhanceArmor"; //enhance stats.armor
		stats.actText[4,actionName]="Enhance Armor";
...
function I1022(object: GameObject){	
	...
	stats.actText[1,func]="MovLinGND"; //gnd lin
		stats.actNums[1,tar]=lin;
...
function I1023(object: GameObject){
	...
	stats.actText[1,func]="MovSerpTRM"; //trm serp
		stats.actNums[1,tar]=serp;
		stats.actNums[1,rng]=2;	
	stats.actText[3,func]="AtkArcEXP"; //arc
		stats.actText[3,actionName]="Lob";
		stats.actNums[3,tar]=arc;
		stats.actNums[3,rng]=3; stats.actNums[3,mag]=10;
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="SpcFortify"; //fortify
		stats.actText[4,actionName]="Fortify";
		stats.actText[4,desc]="+1DEF \nLob & Tactical Missle +1RNG\nLimit: 2";
		stats.actNums[4,ap]=1; stats.actNums[4,fp]=1;
	stats.armor=0;
	stats.actText[5,func]="SpcTacticleMissile"; //tactical missile
...
function I1024(object: GameObject){
	...
	stats.actText[1,func]="MovLinTRM";//lin trm
		stats.actNums[1,tar]=lin;
		stats.actNums[1,rng]=2;
	stats.actText[3,func]="AtkLinNRM";//lin
		stats.actText[3,actionName]="Shoot";
		...
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="AtkArcEXP";
	...
	stats.actText[5,func]="AtkLinFIR";
	...
	stats.actText[8,func]="CreateGND";
	...
	stats.actText[9,func]="CreateTRM";
...
function I1032(object: GameObject){	
	...
	stats.init=2; stats.mob=fly;
	stats.hp=15; stats.mhp=15; stats.def=0;
	stats.actText[1,func]="MovSerpFLY"; //fly serp
		stats.actNums[1,tar]=serp;
		stats.actNums[1,rng]=4;
	stats.actText[3,func]="AtkSerpNRM"; //melee
		stats.actText[3,actionName]="Claw";
		stats.actNums[3,tar]=serp;
		stats.actNums[3,rng]=1; stats.actNums[3,mag]=8;
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="SpcPhoenixPickup"; //pickup
	stats.actText[5,func]="SpcPhoenixDrop"; //drop
...
function I1033(object: GameObject){
	...
	stats.actText[1,func]="MovSerpTRM"; //trm serp
		stats.actNums[1,tar]=serp;
		stats.actNums[1,rng]=3;	
	stats.actText[3,func]="SpcRamuchetize"; //ram/lob
		...
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="SpcMomentum"; //momentum
	...
	stats.actText[5,func]="SpcRamPickup"; //pickup corpse
		stats.actText[5,actionName]="Bring Out Your Dead";
		stats.actText[5,desc]="Pick up any neighboring Corpse."; 
		stats.actNums[5,ap]=0; stats.actNums[5,fp]=1;
		stats.actNums[5,rng]=1;
	stats.actText[6,func]="SpcFlingCorpse"; //fling corpse
...
function I1034(object: GameObject){
	...
	stats.actText[1,func]="MovSerpFLY";//serp fly
		stats.actNums[1,tar]=serp;
		stats.actNums[1,rng]=5;	
	stats.actText[3,func]="AtkSerpNRM";//melee
		...
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="SpcTailSpin";
		...
		stats.actNums[4,dmgtype]=nrml;
	stats.actText[5,func]="SpcSlashBurn";
	...
	stats.actText[6,func]="ModeDragon";
	...
	stats.actText[8,func]="CreateFLY";
...
function I1042(object: GameObject){
	...
	stats.actText[1,func]="MovLinFLY"; //fly lin
		stats.actNums[1,tar]=lin;
		stats.actNums[1,rng]=6;
	stats.actText[3,func]="AtkSerpNRM"; //melee
		stats.actText[3,actionName]="Claw";
		...
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="SpcTransportEnemy"; //transport enemy
...
function I1043(object: GameObject){
	...
	stats.actText[3,func]="AtkSerpNRM"; //melee
		...
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="SpcConsumeTerrain"; //consume terrain
...
function I1044(object: GameObject){
	...
	stats.actText[5,func]="SpcAuralDischarge";
		...
		stats.actNums[5,ap]=1; stats.actNums[5,fp]=2;
	stats.actText[6,func]="SpcTorchOfThaw";
	...
	stats.actText[9,func]="CreateMetaterrainean";
...
function I1051(object: GameObject){
	...
	stats.actText[3,func]="AtkLinNRM";//lin
		...
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="SpcLoad"; //load
		stats.actText[4,actionName]="Load";
		stats.actText[4,desc]="Add 1 bullet.";
		stats.actNums[4,ap]=0; stats.actNums[4,fp]=1;
		stats.bombs=0;
	stats.actText[5,func]="SpcQuickdraw"; //quickdraw
...
function I1052(object: GameObject){
	...
	stats.actText[1,func]="MovSerpGND"; //gnd serp
		stats.actNums[1,tar]=serp;
		stats.actNums[1,rng]=4;	
	stats.actText[3,func]="AtkSerpNRM"; //melee
		...
		stats.actNums[3,rng]=1; stats.actNums[3,mag]=2;
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="SpcPatience"; //patience
		stats.actText[4,actionName]="Patience";
		stats.actText[4,desc]="Neighboring allies +6HP.";
		stats.actNums[4,ap]=1; stats.actNums[4,fp]=1;
	stats.actText[5,func]="CreatePortalGate"; //create gateA
	...
	stats.actText[6,func]="CreatePortalGate"; //create gateB
...
function I1054(object: GameObject){
	...
	stats.actText[3,func]="AtkLinNRM";//lin
		...
		stats.actNums[3,rng]=3; stats.actNums[3,mag]=10;
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="SpcHourSaviour";
	...
	stats.actText[9,func]="CreateGND";
...
function I1060(object: GameObject){
	...
	stats.actText[1,func]=null;
	stats.actText[3,func]="AtkLeech";//leech life
		stats.actText[3,actionName]="Leech Life";
		stats.actText[3,desc]="+1HP per DMG dealt.";
		stats.actNums[3,tar]=serp;
		stats.actNums[3,rng]=1; stats.actNums[3,mag]=5;
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="SpcEvolve";//evolve bee
	...
	stats.actText[5,func]="SpcEvolve";//evolve shrooman
	...
	stats.actText[6,func]="SpcEvolve";//evolve flytrap
...
function I1061(object: GameObject){
	...
	stats.actText[1,func]="MovSerpFLY"; //fly serp
		stats.actNums[1,tar]=serp;
		stats.actNums[1,rng]=5;	
	stats.actText[3,func]="AtkSerpPSN"; //serp psn
	...
	stats.actText[4,func]="SpcDeathSting"; //death sting
...
function I1062(object: GameObject){
	...
	stats.actText[1,func]="MovSerpGND"; //gnd serp
		stats.actNums[1,tar]=serp;
		stats.actNums[1,rng]=2;	
	stats.actText[3,func]="AtkArcPSN"; //psn spores
	...
	stats.actText[4,func]="SpcInfestCorpse"; //infest corpse
...
function I1063(object: GameObject){
	...
	stats.actText[3,func]="SpcEnsnare"; //ensnare
...
function I1064(object: GameObject){
	...
	stats.actText[3,func]="AtkSerpNRM";//melee
		...
		stats.actNums[3,rng]=1; stats.actNums[3,mag]=10;
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="SpcWebshot";
	...
	stats.actText[5,func]="SpcSwarm";
		...
		stats.actNums[5,ap]=1; stats.actNums[5,fp]=2;
	stats.actText[6,func]="SpcMegadearth";
...
function I1071(object: GameObject){
	...
	stats.init=2; stats.mob=trm;
	stats.hp=12; stats.mhp=12; stats.def=0;
	stats.actText[1,func]="MovSerpTRM";//serp trm
		stats.actNums[1,tar]=serp;
		stats.actNums[1,rng]=3;	
	stats.actText[3,func]="AtkLinNRM";//lin
		stats.actText[3,actionName]="Shoot";
		...
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="AtkLinLSR"; //prism cannon
...
function I1072(object: GameObject){
	...
	stats.actText[1,func]="MovSerpGAS"; //gas serp
		stats.actNums[1,tar]=serp;
		stats.actNums[1,rng]=2;	
	stats.actText[3,func]="SpcMnemonicPlague"; //melee
		...
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="SpcAccumulate"; //accumulation
		...
		stats.actNums[4,ap]=1; stats.actNums[4,fp]=1;
	//stats.actText[5,func]="SpcMirage"; //mirage
	...
	stats.actText[6,func]="SpcTractorGust"; //tractor gust
...
function I1073(object: GameObject){
	...
	stats.actText[3,func]="AtkSerpNRM"; //melee
		...
		stats.actNums[3,rng]=1; stats.actNums[3,mag]=9;
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="SpcForceShove"; //force shove
	stats.actText[5,func]="SpcSuperShove"; //super shove
}
function I1074(object: GameObject){
	...
	stats.actText[3,func]="AtkLinNRM";//lin
		...
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="SpcRestoration";
...
function I1081(object: GameObject){
	...
	stats.actText[3,func]="AtkRage";
		...
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="SpcCannibalize"; //cannibalize
	...
	stats.actText[5,func]="SpcExplode"; //explode
...
function I1082(object: GameObject){
	...
	stats.actText[3,func]="AtkSerpNRM"; //melee
		...
		stats.actNums[3,rng]=1; stats.actNums[3,mag]=6;
		stats.actNums[3,dmgtype]=nrml;
	stats.actText[4,func]="SpcMoveCorpse"; //move corpse
		stats.actText[4,actionName]="Move Corpse";
		stats.actText[4,desc]="Move any neighboring Corpse to any legal cell.";
		stats.actNums[4,ap]=1; stats.actNums[4,fp]=1;
		stats.actNums[4,rng]=1;
		stats.actNums[4,tar]=serp;
	stats.actText[5,func]="SpcContagion"; //contagion
	stats.actText[6,func]="CreateVoidGate"; //open void gate
...
function I1083(object: GameObject){
	...
	stats.actText[1,func]="MovSerpTRM"; //trm serp
		stats.actNums[1,tar]=serp;
		stats.actNums[1,rng]=4;	
	stats.actText[3,func]="AtkLinFIR"; 
	...
	stats.actText[4,func]="ModeMagman"; //transform
...
function I1084(object: GameObject){
	...
	stats.actText[5,func]="SpcDevour";
		...
		stats.actNums[5,rng]=1; stats.actNums[5,mag]=10;
		stats.actNums[5,dmgtype]=nrml;
	stats.actText[6,func]="AtkLinFIR";
	...
	stats.actText[7,func]="CreateCorpseFiend";
