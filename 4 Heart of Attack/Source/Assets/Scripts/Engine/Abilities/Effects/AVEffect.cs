...
namespace HOA {
    ...
    public class AVEffect
    {

        public Texture2D Image { get; private set; }
        public AudioClip Sound { get; private set; }

        public AVEffect(Texture2D image, AudioClip sound)
        {
            Image = image;
            Sound = sound;
        }

        public AVEffect(string imageFileName, string soundFileName)
        {
            Image = Resources.Load("Images/Effects/" + imageFileName) as Texture2D;
            Sound = Resources.Load("Audio/Effects/" + soundFileName) as AudioClip;
        }
        ...
        public void PlayNonLocal() { if (Sound != null) Mixer.Play(Sound); }
